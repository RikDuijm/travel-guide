...
//markers
    ...
    var locationsArequipa = [
        ['<h5>Plaza de Armas</h5><p>Wellicht het mooiste stadsplein van Peru. De gebouwen aan de Plaza de Armas in Arequipa zijn opgetrokken uit wit sillar-steen, afkomstig van de nabije vulkanen. Moorse invloeden zijn duidelijk zichtbaar. Het is in Arequipa altijd mooi weer en heerlijk zitten op de dakterrassen die het plein omringen. </p><img src="assets/images/arequipa-plaza.jpg" width="100%" alt="Plaza de Armas, Arequipa">', -16.3988907, -71.536915, camera],
        ['<h5>Monasterio de Santa Catalinta</h5><p>Een complex van 20.000 vierkante meter, haast een stad binnen Arequipa. Het Santa Catalina-klooster werd in 1580 gesticht en het was gebruikelijk dat de jongere dochters van rijke families hier als non dienden. Eenmaal binnen de deuren, kregen ze een opleiding van 4 jaar. Daarna mochten ze kiezen om het klooster in schaamte te verlaten, of voor altijd binnen de kloostergronden te blijven…</p><img src="assets/images/arequipa-monasterio.jpg" width="100%" alt="Monasterio de Santa Catalina, Arequipa">', -16.395141, -71.536774, camera],
        ...
        ['<h5>Barrio de San Lázaro</h5><p>Het oudste stukje Arequipa, gesticht rond 1540, is autoluw, en heerlijk om in te wandelen en weg te dromen. Een werkelijk schitterende, historische locatie waar je maar weinig andere mensen tegenkomt. Het spreekt tot de verbeelding!</p><img src="assets/images/arequipa-sanlazaro.jpg" width="100%" alt="Barrio de San Lázaro, Arequipa">', -16.393682, -71.533660, camera],
        ['<h5>Mercado San Camilo</h5><p>Dichtbij het plezante stadscentrum vindt u de grimmige, drukke, zintuig-overdonderende straatjes rondom de markt van San Camilo. Het biedt een fascinerend kijkje in de minder welvarende realiteit van veel Peruanen. U komt ogen te kort! Kijk hier wel uit voor zakkenrollers.</p><img src="assets/images/arequipa-market.jpg" width="100%" alt="Mercado San Camilo, Arequipa">', -16.402717, -71.534836, camera],
        ['<h5>El Misti & Chachani</h5><p>Arequipa ligt in de schaduw van de nog actieve vulkanen El Misti (5825 meter)  en Chachani (6075). Hier komen de witte sillar-stenen, zo kenmerkend voor de gebouwen in Arequipa vandaan. Chachani is 1 van de makkelijkste te beklimmen zesduizenders ter wereld. Nét wat hoger dan de Kilimanjaro!</p><img src="assets/images/arequipa-mountain.jpg" width="100%" alt="El Misti & Chachani, Arequipa">', -16.193399, -71.518899, camera],
        ['<h5>Casa de Avila</h5><p><strong>€</strong><br>39 kamers, ontbijtbuffet, 30 meter van de straat, zonnige tuin, culturele klassen<br><a href="https://www.casadeavila.com/" target="_blank">website</a><br><br><em>Midden in de stad gelegen heeft Casa de Avila 3 grote pluspunten: de zonnige tuin, de goede prijs-kwaliteit verhouding en de culturele klassen (kookles, Spaanse les) die men biedt.</em></p><img src="assets/images/arequipa-hotel-avila.jpg" width="100%" alt="Casa de Avila, Arequipa">', -16.402642, -71.540461, hotel],
        ['<h5>La Hosteria</h5><p><strong>€€</strong><br>16 kamers, ontbijtbuffet, centraal gelegen, kamers met openhaard, patio<br><a href="http://www.lahosteriaqp.com.pe/" target="_blank">website</a><br><br><em>Tegenover het klooster van Santa Catalina gelegen, is dit één van de beste accommodaties van Arequipa. Mooi ingerichte kamers, een charmante binnenplaats en vriendelijke medewerkers. Minpuntje is dat de verkeersdrukte wat doordringt tot sommige kamers.</em></p><img src="assets/images/arequipa-hotel-hosteria.jpg" width="100%" alt="La Hosteria, Arequipa">', -16.394266, -71.537105, hotel],
        ['<h5>Casona Solar</h5><p><strong>€€</strong><br>12 kamers, ontbijtbuffet, zeer sfeervol, twee binnentuinen<br><a href="http://www.casonasolar.com" target="_blank">website</a><br><br><em>Zeer sfeervol hotel, in een koloniaal herenhuis uit 1702, opgetrokken uit wit sillar-gesteente. De kamers ogen stuk voor stuk romantisch, met hoge gebogen daken en leiden alle naar de centrale binnenplaatsen. Een heerlijk ontbijtbuffet maakt dat dit hotel één van onze keuzes in Arequipa is!</em></p><img src="assets/images/arequipa-hotel-casona.jpg" width="100%" alt="Casona Solar, Arequipa">', -16.401777, -71.537058, hotel],
        ['<h5>Katari Hotel</h5><p><strong>€€€</strong><br>18 kamers, ontbijtbuffet, pal aan stadsplein restaurant op dakterras met uitzicht, spa<br><a href="https://hotelkatari.com" target="_blank">website</a><br><br><em>Aan de schitterende Plaza de Armas van Arequipa, centraler kan niet! Mooi ingerichte kamers, een heerlijk restaurant op het dakterras met fabuleus uitzicht en een spa. Wij weten waar we de volgende keer in Arequipa overnachten!</em></p><img src="assets/images/arequipa-hotel-katari.jpg" width="100%" alt="Katari Hotel, Arequipa">', -16.399393, -71.537182, hotel],
    ...
    var locationsCusco = [
        ...
        ['<h5>Mercado de San Pedro</h5><p>Een spektakel voor de zintuigen: van groente, fruit en vlees, tot chicha (Inca-bier, gebrouwen uit maís) en van gewoven kleden tot te offeren lama-foetussen. Op de centrale markt kijkt u uw ogen uit. Doe dat ook voor zakkenrollers!</p><img src="assets/images/cusco-market.jpg" width="100%" alt="Mercado San Pedro, Cusco">', -13.521096, -71.982496, camera],
        ...
        ['<h5>Regenwoud van Manu</h5><p>De regio van Manu, in de Amazone, wordt geroemd als een van de regio’s met de grootste biodiversiteit ter wereld. Het is ook één van de minst betreden gebieden. Hemelsbreed slechts 100 kilometer van Cusco lopen inheemse stammen rond die nog nooit contact hebben gehad met de rest van de wereld.</p><img src="assets/images/cusco-manu.jpg" width="100%" alt="Regenwoud Manu">', -12.221888, -71.001184, camera],
